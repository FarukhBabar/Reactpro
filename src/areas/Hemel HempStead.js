...
const HemelHempStead = () => {
  return (
    ...
    <Helmet>
      ...
      // Text
      pageTitle="Hemel Hempstead"
      firstHeading='Amica & Commode Mobile Tyre Fitting Hemel Hempstead.'
      secondHeading="Mobile Tyre Fitting in & Around Hemel Hempstead"
      img1={About1}
      lione='One'
      litwo='Two'
      lithree='Three'
