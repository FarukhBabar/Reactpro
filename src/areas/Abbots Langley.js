...
const AbbotsLangley = () => {
  return (
    ...
    <Helmet>
      ...
      // Text
      pageTitle="Abbots Langley"
      firstHeading='Amica & Commode Mobile Tyre Fitting Abbots Langley.'
      secondHeading="Mobile Tyre Fitting in & Around Abbots Langley"
      img1={About1}
      lione='One'
      litwo='Two'
      lithree='Three'
