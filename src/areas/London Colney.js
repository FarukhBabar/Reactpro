...
const LondonColney = () => {
  return (
    ...
    <Helmet>
      ...
      // Text
      pageTitle="London Colney"
      firstHeading='Amica & Commode Mobile Tyre Fitting London Colney.'
      secondHeading="Mobile Tyre Fitting in & Around London Colney"
      img1={About1}
      lione='One'
      litwo='Two'
      lithree='Three'
