...
const WheatHampstead = () => {
  return (
    ...
    <Helmet>
      ...
      // Text
      pageTitle="Wheathampstead"
      firstHeading='Amica & Commode Mobile Tyre Fitting Wheathampstead.'
      secondHeading="Mobile Tyre Fitting in & Around Wheathampstead"
      img1={About1}
      lione='One'
      litwo='Two'
      lithree='Three'
