...
const Borehamwood = () => {
  return (
    ...
    <Helmet>
      ...
      // Text
      pageTitle="Borehamwood"
      firstHeading='Amica & Commode Mobile Tyre Fitting Borehamwood.'
      secondHeading="Mobile Tyre Fitting in & Around Borehamwood"
      img1={About1}
      lione='One'
      litwo='Two'
      lithree='Three'
