              ...
              <div className="pc-bi-box">
                ...
                <div className="pc-home-banner-icon d-flex gap-2 align-items-center">
                  ...
                  <div>
                    ...
                    <h5><a href="mailto:info@protyrefitters.co.uk" className="tc-text-color" style={{textDecoration:'none'}}>info@protyrefitters.co.uk</a></h5>
                    <span className="d-block text-white">
                      We are present 24/7
                    </span>
                  </div>
                ...
                <div className="pc-home-banner-icon d-flex gap-2 align-items-center">
                  ...
                  <div>
                    ...
                    <h5><a href="tel: +44 7441428174" className="tc-text-color" style={{textDecoration:'none'}}>+44 7441428174</a></h5>
                    <span className="d-block text-white">
                      We are present 24/7
                    </span>
                  </div>
